...
def call_epochs_plot(history, save_path):
    plot_metric_epochs(history.history['loss'], history.history['val_loss'], "Training Loss", "Validation Loss", "Epochs", "Binary Cross-Entropy Loss", "Loss Comparison", "loss_evolution", save_path)
    plot_metric_epochs(history.history['accuracy'], history.history['val_accuracy'], "Training Accuracy", "Validation Accuracy", "Epochs", "Accuracy", "Accuracy Comparison", "accuracy_evolution", save_path)
